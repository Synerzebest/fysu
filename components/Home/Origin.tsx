...
const Origin = () => {
  return (
    ...
    >
      <h2 className="text-2xl md:text-5xl font-cinzel text-center">FYSU</h2>
      <p className="mt-2 italic text-sm md:text-base text-gray-300 text-center">/ˈfai.su/</p>

      <div className="max-w-4xl mx-auto mt-10 text-xs md:text-base leading-relaxed tracking-wide space-y-4 text-gray-200">
        <p className="font-semibold text-white font-cinzel">
          FYSU ARTISANAL FALL–WINTER 26.
        </p>

        <p className="font-cinzel text-xs">
        ...
        <p className="mt-8 font-semibold text-white font-cinzel">Lack of Love, c’est le point de départ.</p>
        <p className="font-cinzel text-xs">
